    ...
    <div className="relative w-full h-full flex flex-col">
      ...
      <div className="flex justify-center items-center gap-5 py-2 shrink-0">
        <button
          ...
          className="w-12 h-12 rounded-full bg-white shadow-md shadow-gray-200/50 flex items-center justify-center border border-gray-100 hover:shadow-lg active:scale-90 transition-all"
          aria-label="スキップ"
        >
        ...
        <button
          ...
          className="w-10 h-10 rounded-full bg-white shadow-md shadow-gray-200/50 flex items-center justify-center border border-gray-100 hover:shadow-lg active:scale-90 transition-all"
          aria-label="詳細を見る"
        >
        ...
        <button
          ...
          className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-400 to-green-500 shadow-md shadow-emerald-200/50 flex items-center justify-center hover:shadow-lg active:scale-90 transition-all"
          aria-label="LIKE"
        >
