  ...
  return (
    <DashboardShell>
      <div className="px-4 lg:px-8 py-6 lg:py-8 max-w-7xl mx-auto space-y-6">
        {/* Demo banner */}
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl px-5 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <Link
            ...
            className="shrink-0 px-5 py-2 rounded-xl bg-white text-blue-700 text-[12px] font-extrabold shadow-lg hover:bg-cyan-50 active:scale-[0.97] transition"
          >
            ファウンディング申込 →
          </Link>
        </div>
